...
define('calendar_views/event',['sandbox'], function(sandbox) {
  "use strict";
...
define('calendar_models/event',['sandbox'], function(sandbox) {
  "use strict";
...
define('text!calendar_templates/base.html',[],function () { return '<div class="widget">\n  <div class="content"></div>\n  <div id="event-dialog-form" class=\'dialog ui-helper-hidden\'>\n    <form>\n      <fieldset>\n        <div>\n          <label>Title:</label>\n          <input id=\'title\' class="field" type="text" />\n        </div>\n        <div>\n          <label>Color:</label>\n          <input id=\'color\' class="field" type="text" />\n        </div>\n      </fieldset>\n    </form>\n  </div>\n</div>\n';});

define('calendar_views/app',['sandbox', 'calendar_views/event', 'calendar_models/event', 'text!calendar_templates/base.html'], function(sandbox, EventView, Event, baseTemplate) {
  "use strict";
...
define('calendar_collections/events',['sandbox', 'calendar_models/event'], function(sandbox, Event) {
  "use strict";
...
define("fullcalendar", ["jquery"], (function (global) {
    return function () {
        return global.$.fullCalendar;
    }
}(this)));

define('../../../widgets/calendar/main',['sandbox', 'calendar_views/app', 'calendar_collections/events', 'fullcalendar'], function(sandbox, AppView, Events) {
  "use strict";
