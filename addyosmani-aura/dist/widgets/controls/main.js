...
define('text!controls_templates/controls.html',[],function () { return '<button class="start-todos">Start Todos</button>\n<button class="stop-todos">Stop Todos</button>\n<button class="start-calendar">Start Calendar</button>\n<button class="stop-calendar">Stop Calendar</button>\n<button class="start-all">Start All</button>\n<button class="publish-data">Publish Data</button>\n';});

define('controls_views/app',['sandbox', 'text!controls_templates/controls.html'], function(sandbox, controlTemplate) {
  "use strict";
...
define('../../../widgets/controls/main',['sandbox', 'controls_views/app'], function(sandbox, AppView) {
  "use strict";
